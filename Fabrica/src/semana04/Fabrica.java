...
public class Fabrica extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnProcesar(ActionEvent arg0) {
		...
		p = Double.parseDouble(txtPrecio.getText());
		...
		txtS.setText("Importe compra    : " + decimalFormat(C) +"\n");
		imprimir("Importe descuento : " + decimalFormat(D));
		imprimir("Importe pagar     : " + decimalFormat(P));
